...
!(function () {
  ...
  function t(e, t) {
    ...
    if (
      ...
      for (
        var i = n.slice(0, n.lastIndexOf("/") + 1) + e, o = [], u = -1, c = 0;
        i.length > c;
        c++
      )
        -1 !== u
          ? "/" === i[c] && (o.push(i.slice(u, c + 1)), (u = -1))
          : "." === i[c]
  ...
  function i(e, n, r, i, o) {
    for (var u in e) {
      ...
      if ("string" == typeof a) {
        var l = s(i, t(a, r) || a, o);
        l ? (n[f] = l) : c("W1", u, a, "bare specifier did not resolve");
      }
    }
  }
  function o(e, t) {
  ...
  function u(e, t) {
    ...
    if (n) {
      ...
      c("W2", n, r, "should have a trailing '/'");
    }
  }
  function c(t, n, r, i) {
    console.warn(
  ...
  function l(e, t, n) {
    if ((e.onload(n, t.id, t.d && t.d.map(a)), n)) throw n;
  }
  function d(e, t) {
    g &&
      [].forEach.call(
        document.querySelectorAll('script[type="systemjs-importmap"]' + t),
        e
      );
  }
  function h() {
    [].forEach.call(
      ...
      function (e) {
        e.src &&
          System.import(
            "import:" === e.src.slice(0, 7) ? e.src.slice(7) : n(e.src, v)
          );
      }
    );
  }
      ...
      .then(function (t) {
        var n = (function t(n, r, i) {
          ...
          var s = Promise.resolve()
              ...
              .then(function (t) {
                if (!t)
                  throw Error(e(2, "Module " + r + " did not instantiate"));
                var i = t[1](
                  function (e, t) {
                    o.h = !0;
                    var n = !1;
                    ...
                    if (n) for (var i = 0; u.length > i; i++) u[i](c);
                    return t;
                  },
                  2 === t[1].length
                    ? {
                ...
                return (
                  (o.e = i.execute || function () {}), [t[0], i.setters || []]
                );
              }),
            f = (s = s.catch(function (e) {
              l(n, o, e);
            })).then(function (e) {
              return Promise.all(
              ...
              return (
                ...
                .then(function (t) {
                  try {
                    ...
                    throw Error(
                      e(1, "systemjs-importmap contains invalid JSON")
                    );
                  }
                })
                .then(function (e) {
                  t[P] = (function (e, t, o) {
                    ...
                    if (
                      (e.imports && i(e.imports, u.imports, t, o, null),
                      e.scopes)
                    )
                      for (var c in e.scopes) {
                        var s = n(c, t);
                        i(
                          e.scopes[c],
                          u.scopes[s] || (u.scopes[s] = {}),
                          t,
                          o,
                          s
                        );
  ...
  (w.register = function (e, t) {
    ...
    (w.instantiate = function (t, n) {
      ...
      return new Promise(function (i, o) {
        var u = w.createScript(t);
        u.addEventListener("error", function () {
          o(Error(e(3, "Error loading " + t + (n ? " from " + n : ""))));
        }),
          u.addEventListener("load", function () {
            document.head.removeChild(u), I === t ? o(L) : i(r.getRegister());
          }),
    ...
    (function (e) {
      function t(t) {
        return (
          !e.hasOwnProperty(t) ||
          (!isNaN(t) && e.length > t) ||
          (f && e[t] && "undefined" != typeof window && e[t].parent === window)
        );
      }
      var n,
        r,
        i,
        o = System.constructor.prototype,
        u = o.import;
      o.import = function (o, c) {
        return (
          (function () {
    ...
    (function (t) {
      var n = t.System.constructor.prototype,
        r = n.instantiate;
      (n.shouldFetch = function (e) {
        var t = e.split("?")[0].split("#")[0];
        return t.slice(t.lastIndexOf(".")).match(/\.(css|html|json|wasm)$/);
      }),
        (n.fetch = function (e) {
          return fetch(e);
        }),
        (n.instantiate = function (t, n) {
          var i = this;
          return this.shouldFetch(t)
            ? this.fetch(t).then(function (r) {
                if (!r.ok)
                  throw Error(
                    e(
                      7,
                ...
                if (o.match(/^(text|application)\/(x-)?javascript(;|$)/))
                  return r.text().then(function (e) {
                    return (0, eval)(e), i.getRegister();
                  });
                if (o.match(/^application\/json(;|$)/))
                  return r.text().then(function (e) {
                    return [
                      [],
                      function (t) {
                ...
                if (o.match(/^application\/wasm(;|$)/))
                  return (
                    WebAssembly.compileStreaming
                      ? WebAssembly.compileStreaming(r)
                      : r.arrayBuffer().then(WebAssembly.compile)
                  ).then(function (e) {
                    var t = [],
                      n = [],
                      r = {};
                    return (
                      WebAssembly.Module.imports &&
                        WebAssembly.Module.imports(e).forEach(function (e) {
                          var i = e.module;
                          -1 === t.indexOf(i) &&
                            (t.push(i),
                            n.push(function (e) {
                      ...
                      [
                        ...
                        function (t) {
                          return {
                            setters: n,
                            execute: function () {
                              return WebAssembly.instantiate(e, r).then(
                                function (e) {
                                  t(e.exports);
                                }
                              );
                ...
                throw Error(e(4, 'Unknown module type "' + o + '"'));
              })
            : r.apply(this, arguments);
        });
    })("undefined" != typeof self ? self : global);
  var _ = "undefined" != typeof Symbol && Symbol.toStringTag;
  (w.get = function (e) {
    var t = this[O][e];
    ...
    (w.set = function (t, n) {
      ...
      _ && "Module" === n[_]
        ...
        : ((r = Object.assign(Object.create(null), n)),
          _ && Object.defineProperty(r, _, { value: "Module" }));
